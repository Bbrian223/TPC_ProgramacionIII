...
/*	Tabla de mesas asignadas a empleados*/
CREATE TABLE Mesas_X_Empleados(
	IDMESA BIGINT,
	IDEMPLEADO BIGINT

	PRIMARY KEY(IDMESA,IDEMPLEADO),
...
CREATE TABLE Pedidos(
	...
	FOREIGN KEY(IDMESA) REFERENCES Mesas(IDMESA),
	FOREIGN KEY(IDUSUARIO) REFERENCES Usuarios(IDUSUARIO),
	CONSTRAINT CHK_ESTADOPEDIDO CHECK(ESTADO IN ('EN PROCESO','COMPLETADO','CANCELADO'))
)
GO
...
VALUES ('CAFETERIA'),('ENTRADAS'),('COMIDAS'),('POSTRES'),('BEBIDAS'),('GUARNICIONES'),('LECHES'),('TAZAS')
