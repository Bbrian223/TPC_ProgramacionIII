...
SELECT U.IDUSUARIO,U.NOMBRE,U.CONTRASENIA,R.NOMBRE AS 'ROL', U.ESTADO FROM Usuarios U
INNER JOIN Roles R ON R.IDROL = U.IDROL

DECLARE @NOM VARCHAR(100) = 'Master'
DECLARE @CONTRA VARCHAR(100) = 'Master'
SELECT IDUSUARIO,NOMBRE,CONTRASENIA,IDROL FROM Usuarios WHERE NOMBRE = @NOM AND CONTRASENIA = @CONTRA AND ESTADO = 1
